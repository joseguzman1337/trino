        ...
        implements ConnectorPageSinkProvider
{
    ...
    {
        return forHandle(outputTableHandle).createPageSink(transactionHandle, session, outputTableHandle, credentials, pageSinkId);
    }
    ...
    {
        return forHandle(insertTableHandle).createPageSink(transactionHandle, session, insertTableHandle, credentials, pageSinkId);
    }
    ...
    {
        return forHandle(tableExecuteHandle).createPageSink(transactionHandle, session, tableExecuteHandle, credentials, pageSinkId);
    }
    ...
    {
        return forHandle(mergeHandle).createMergeSink(transactionHandle, session, mergeHandle, credentials, pageSinkId);
    }
